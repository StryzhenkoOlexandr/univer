...
def heapsort(arr):
    ...
    for i in range(n // 2 - 1, -1, -1):
        ...
        sink(arr, i, n)
        print(f"Масив після занурення: {arr}")
    ...
    for i in range(n - 1, 0, -1):
        ...
        print(f"Розмір купи зменшився до {i}. Відновлюємо властивості купи.")
        sink(arr, 0, i)
...
print("=" * 50)
print("СОРТУВАННЯ КУПОЮ ДЛЯ ВАРІАНТУ 19")
print("=" * 50)
sorted_A = heapsort(A)
